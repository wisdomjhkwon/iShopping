...
export class
    ...
    key: string;
    date: string;
    constructor(id?: Array<string>, techTypes?: Array<string>, type: string = TAG_TYPE) {
        this.id = id;
...
export class NdefTag extends Tag {
    ...
    constructor(id: Array<string>, techTypes: Array<string>, canMakeReadOnly: boolean, isWritable: boolean, maxSize: number) {
